   ...
   // ImageIcon ii, i1, i2, i3, i4;
     ...
     public Introduce()
     {
       // ImageIcon ii, i1, i2, i3, i4;
        ...
        //i1 = new ImageIcon("Owner2.png");
        owner.setIcon(i1);
        owner.setBounds(20, 150, 120, 50);
        add(owner);
        
        i2 = new ImageIcon("open.png");
        JButton open = new JButton("Open");
        open.setIcon(i2);
        open.setBounds(20, 260, 120, 50);
        add(open);
       ...
       // help.setBackground(Color.GREEN); 
        ...
        th.setFont(font3);
        th.setIcon(i4);
        th.setBounds(270, 565, 400, 30);
        add(th);
      
         ImageIcon shr = new ImageIcon("shareit .png");
         JLabel sr = new JLabel("Share it");
         sr.setIcon(shr);
         sr.setBounds(0, 0, 800, 650);
         add(sr);
